...
def test_serper_api():
    """Test Serper API connection and authentication"""
...
def test_crewai_serper():
    """Test SerperDevTool from CrewAI"""
    
    print("\n=== Testing CrewAI SerperDevTool ===")
...
if __name__ == "__main__":
    print("Starting Serper API diagnostics...\n")
    
    # Test direct API
    api_success = test_serper_api()
